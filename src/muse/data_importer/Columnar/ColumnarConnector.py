...
class ColumnarConnector(Importer):
    ...
    def _import_csv(data, document_type):
        ...
        if document_type == 'multi-document':
            return ColumnarConnector._create_multi_document_csv(pd.read_csv(data.content))
    ...
    def _import_parquet(data, document_type):
        ...
        if document_type == 'multi-document':
            return ColumnarConnector._create_multi_document_csv(pd.read_parquet(data.content))
        if document_type == 'conversation':
            return ColumnarConnector._create_conversation_csv(pd.read_parquet(data.content))
